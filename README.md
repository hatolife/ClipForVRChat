...
- 自動投稿用Webhook URL: 自動投稿だけ別のDiscordチャンネルに投稿したい場合に入力します。空なら通常のWebhook URLを使います。
...
- スクリーンショット投稿用Webhook URL: スクリーンショット自動投稿だけ別のDiscordチャンネルに投稿したい場合に入力します。空なら通常のWebhook URLを使います。
