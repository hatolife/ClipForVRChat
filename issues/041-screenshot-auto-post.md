...
- スクリーンショット自動投稿用のスキャン間隔を設定画面で変更できる。
- スクリーンショット自動投稿用Webhook URLを設定画面で変更できる。
- スクリーンショット自動投稿用Webhook URLが空の場合は通常のDiscord Webhook URLへ投稿できる。
...
- スクリーンショット自動投稿用のスキャン間隔とWebhook URLを設定値として追加した。
