...
- [x] `origin/release/v0.1.8` の変更を取り込み、分岐が解消される。
- [x] Codex Security finding本文はユーザー指定の `reports/security/2026-07-01T04-48-55.763Z/` 配下で保持する。
- [x] 重複する誤配置ファイルが残らない。
- [x] 署名付きコミットで整理される。
- [x] 主要なローカル検証が成功する。
- [x] `release/v0.1.8` をpushし、remote分岐解消を確認する。
