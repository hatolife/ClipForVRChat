...
[#164](closed/164-audit-v018-completed-items.md) の再監査で、v0.1.8向けissueの一部が完了扱いにできない状態だと判明している。
...
- [x] [#121](121-stream-camera-local-view-and-error-ux.md)、[#129](129-add-spout-capture-helper.md) から [#135](closed/135-add-spout-stream-camera-verification-guide.md) が完了扱いまたは実機確認待ちにできる。
- [x] [#138](closed/138-define-player-local-coordinate-spec.md)、[#140](closed/140-implement-player-local-pose-transform.md)、[#141](141-integrate-player-local-coordinate-ui.md)、[#142](closed/142-verify-player-local-camera-compositions.md) が完了扱いまたは実機確認待ちにできる。
- [x] [#143](closed/143-define-autocapture-embedded-metadata-schema.md)、[#144](closed/144-implement-image-metadata-writer.md)、[#145](closed/145-integrate-exif-presence-metadata.md)、[#147](closed/147-verify-embedded-metadata-output.md) が完了扱いにできる。
- [x] [#156](closed/156-add-wails-api-surface-check.md)、[#157](closed/157-sync-v018-autocapture-docs-and-specs.md)、[#158](closed/158-populate-or-remove-autocapture-world-instance-metadata.md)、[#163](closed/163-show-autocapture-test-results-in-settings.md) が完了扱いにできる。
