...
- 2026-07-01に `C:\Users\user\Downloads\ClipForVRChat-v0.1.8-a11-windows-amd64` の `config.json`、`history.json`、`logs` へ `icacls` を実行し、`Everyone` や広い `Users` 権限が表示されないことを確認した。
