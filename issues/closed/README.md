...
| 256 | [v0.1.8仕様に合わせて使い方画面の文面を実装する](unreleased/256-rewrite-help-screen-copy-for-v018.md) | 完了 | 未定 | 使い方画面をカード形式から本文形式へ変更し、基本操作、自動撮影、AvatarBeacon導入、結果・ログ確認を段階的に読める構成へ更新した。 |
