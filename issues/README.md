...
| 109 | [VRChat自動構図撮影](109-vrc-auto-composition-capture.md) | 要確認 | `v0.1.8` | OSCでUser Cameraを制御し、構図ごとの自動撮影とsidecar JSON保存を実装する。 |
| 110 | [VRChat output logからの同席ユーザー保持](110-vrc-output-log-presence-users.md) | 要確認 | `v0.1.8` | output_log監視で撮影時点の同席ユーザー情報を保持し、画像メタデータやDiscord投稿へ紐づける。 |
