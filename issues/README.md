...
| 267 | [AvatarBeacon READMEを汎用OSCギミックとして修正する](267-rewrite-avatarbeacon-readme-as-generic-osc-gimmick.md) | 要対応 | 未定 | READMEからClipForVRChat固有説明を外し、汎用OSCギミックとしての説明、ライセンス表記、句点改行を整理する。 |
