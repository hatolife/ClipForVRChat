...
| 279 | [b14で1枚目成功後に2枚目以降のSpout取得が失敗する](279-fix-b14-spout-sender-missing-after-first-shot.md) | 要確認 | `v0.1.8-b15` | 1枚目成功後にSpout senderが空になる場合、ON再送で戻らなければOFF/ONトグルへ段階的に上げる。 |
