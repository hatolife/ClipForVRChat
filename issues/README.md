...
| 293 | [インポート設定由来の自動処理監視フォルダを確認・制限する](293-guard-imported-auto-processing-watch-directories.md) | 要対応 | 未定 | 外部JSON設定から隠れた監視フォルダとWebhookが有効になり、意図しない画像がDiscord投稿されないよう確認・制限する。 |
