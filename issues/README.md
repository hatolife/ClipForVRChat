...
| 194 | [CIのWails Build application工程が長時間完了しない](194-investigate-ci-wails-build-hang.md) | 要確認 | `v0.1.8-rc32` | rc30/rc31のbranch CIとrc31 ReleaseでWindows `wails build` が長時間完了しない原因を切り分け、WebView2 strategy明示とtimeout/verboseを追加する。 |
