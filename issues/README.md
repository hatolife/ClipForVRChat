...
| 286 | [Release公開Assetを規約どおり3種類に限定する](286-limit-release-assets-to-three-files.md) | 要対応 | `v0.1.8-rc5` | AvatarBeacon packageはzip内だけに同梱し、GitHub Releaseの公開Assetを3種類に限定する。 |
